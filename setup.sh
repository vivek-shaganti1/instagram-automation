...
source "$VENV_DIR/bin/activate"
cd "$PROJECT_DIR"
python backend/python/main.py --research-only 2>&1 | head -30 || echo "⚠️  Test run failed. Check your .env credentials."
...
echo ""
echo "📋 Quick commands:"
echo "   Test the system:     python backend/python/main.py --dry-run"
echo "   Post 1 test:         python backend/python/main.py --test-post"
echo "   Run everything now:  python backend/python/main.py"
...
echo "   2. Run: python backend/python/main.py --dry-run  (to test without posting)"
echo "   3. Run: python backend/python/main.py --test-post  (to post 1 test carousel)"
